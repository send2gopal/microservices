...
namespace microkart.notification;
public static class StartupExtensions
{
    public const string AppName = "Notification Service";
    ...
    public static async Task AddDbContextAsync(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddDbContext<NotificationDatabaseContext>(
    ...
    public static void AddDbContextDevelopment(this WebApplicationBuilder builder)
    {
        ...
        var defaultConnectionString = builder.Configuration["ConnectionStrings:NotificationDB"];
